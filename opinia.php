<?php
    ...
    try
    {
        ...
        if($polaczenie->query("INSERT INTO opinie VALUES (NULL, '$usr','$tresc')"))
        {
...
<body>
    ...
    <!--Przesyłanie opinii/sugestii przez użytkownika. Uprawienia użytkownika połączone z ui-->
    <div id="baner_inf">
    <form method="post">
    Treść opinii/sugestii: <br /> <textarea rows="5" cols="80" id="lot_text"  name="opinia" ></textarea><br />
       <br> <input type="submit" value="Prześij" id="zaloguj_sie"/>
    </form>
