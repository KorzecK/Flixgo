		...
		try 
		{
			...
			else
			{
				...
				if ($wszystko_OK==true)
				{
					...
					if ($polaczenie->query("INSERT INTO uzytkownicy VALUES (NULL, '$nick', '$haslo_hash', '$email', '$avatar')"))
					{
...
<body>
    ...
    <!--Rejestracja do serwisu, modyfikująca bazę danych na podstawie wysyłanego formularza-->
    <div id="p_rej">
	<form method="post">
		...
		<input type="submit" value="Zarejestruj się" id="zaloguj_sie"/>
